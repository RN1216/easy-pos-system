...
const SidebarNav = () => {
  ...
  return (
    <Sidebar rootStyles={{
      ...
      <button onClick={() => collapseSidebar()}><MdArrowCircleRight className=' mx-5 text-4xl font-semibold'/></button>
      <Menu rootStyles={{
            ['.' + menuClasses.button]: {
              backgroundColor: 'black',
              color: 'white',
        ...
        <MenuItem icon={<MdOutlineDashboardCustomize/>} component={<Link to="/" />}>Dashboard</MenuItem>
        <MenuItem icon={<MdOutlinePointOfSale/>} component={<Link to="/pos" />}> POS</MenuItem>
        <SubMenu defaultClose icon={<MdOutlineInventory2/>} label="Inventory">
